...
class TestXDate(DateTest):
    ...
    def test_should_return_correct_date_object_given_date_with_different_timezone_negative_offset(self):
        date = XDate().translate("2002-09-24-06:00")
        self.assertEqual(date.day, self.getDay(24, 0, -6))
